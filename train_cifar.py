...
def _generate_image_and_label_batch(image, label, min_queue_examples,
  ...
  """
    ...
    print("_generate_image_and_label_batch called")
...
def get_test_data(eval_data, data_dir, batch_size):
    """Construct input for CIFAR testing using the Reader ops.
...
images_test, labels_test = get_test_data(True, FLAGS.data_dir, FLAGS.batch_size)
